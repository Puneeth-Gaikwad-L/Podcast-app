...
function EpisodesDetail({ index, title, desc, audioFile, onClick }) {
    return (
        <div style={{ marginTop: "10px" }}>
            ...
            <Button icons={<CaretRightFilled />} text={"Play"} onClick={() => onClick(audioFile)} style={{ width: "150px", margin: "0", marginLeft: "15px", display: "flex", alignItems: "center", justifyContent: "center", gap: "5px" }} />
        </div>
    )
}
